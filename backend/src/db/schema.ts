...
export const emailTemplates = sqliteTable('email_templates', {
  ...
  headerLogoSize: text('header_logo_size').$type<'xs'|'small'|'medium'|'large'|'xl'>().default('medium'),
  headerImageSize: text('header_image_size').$type<'xs'|'small'|'medium'|'large'|'xl'>().default('medium'),
  signatureLogoSize: text('signature_logo_size').$type<'xs'|'small'|'medium'|'large'|'xl'>().default('medium'),
